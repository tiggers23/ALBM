...
import datasets.food101_tensor
import datasets.oxford_flowers_tensor
import datasets.cub_tensor
import datasets.dtd_tensor
import datasets.fgvc_aircaraft_tensor
import datasets.oxford_pets_tensor
import datasets.places365_tensor
import datasets.cifar10
import datasets.cifar10_tensor
import datasets.cifar100_tensor
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.MAPLE.INITED = False       # inite type
    #cfg.TRAINER.MAPLE.TRAIN_W = False      # train prompt or weight_matrix
