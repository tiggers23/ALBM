...
base_file_path = "/home/tiggers/mydisk/lql/datasets/oxfordpets/pets-base.txt"
novel_file_path = "/home/tiggers/mydisk/lql/datasets/oxfordpets/pets-novel.txt"
...
class OxfordPets(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        self.split_path = os.path.join(self.dataset_dir, "split_zhou_OxfordPets_onlytest1.json")
        ...
        for value in sort_label:
            sort_cls[value] = cls_name[value].lower().replace('_', ' ')
        ...
        for value in sort_label:
            sort_cls_novel[value] = cls_name_novel[value].lower().replace('_', ' ')
    ...
    def subsample_classes(*args, subsample="all"):
        ...
        if subsample == "base":
            ...
            print("Selected classes:", labels[:m])
        else:
