...
base_file_path = "/home/tiggers/mydisk/lql/datasets/Place365/places365_standard/places-base.txt"
novel_file_path = "/home/tiggers/mydisk/lql/datasets/Place365/places365_standard/places-novel.txt"

@DATASET_REGISTRY.register()
class Places365(DatasetBase):

    dataset_dir = "Place365/places365_standard"
    ...
    def __init__(self, cfg):
        ...
        self.split_path = os.path.join(self.dataset_dir, "split_ours_places.json")
