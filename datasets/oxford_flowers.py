...
base_file_path = "/home/tiggers/mydisk/lql/datasets/oxford_flower/flowers102-base.txt"
novel_file_path = "/home/tiggers/mydisk/lql/datasets/oxford_flower/flowers102-novel.txt"

@DATASET_REGISTRY.register()
class OxfordFlowers(DatasetBase):

    #dataset_dir = "Flowers"
    dataset_dir = "oxford_flower"
    ...
    def __init__(self, cfg):
        ...
        #self.split_path = os.path.join(self.dataset_dir, "split_zhou_OxfordFlowers_onlytest1.json")
