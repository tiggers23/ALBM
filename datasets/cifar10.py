...
base_file_path = "/home/tiggers/mydisk/lql/datasets/CIFAR10/cifar10-base.txt"
novel_file_path = "/home/tiggers/mydisk/lql/datasets/CIFAR10/cifar10-novel.txt"
...
class cifar10(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        self.split_path = os.path.join(self.dataset_dir, "split_ours_cifar10.json")
        ...
        if num_shots >= 1:
            seed = cfg.SEED
            preprocessed = os.path.join(self.split_fewshot_dir, f"shot_{num_shots}-seed_1.pkl")
