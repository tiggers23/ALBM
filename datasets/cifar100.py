...
base_file_path = "/home/tiggers/mydisk/lql/datasets/CIFAR100/cifar100-base.txt"
novel_file_path = "/home/tiggers/mydisk/lql/datasets/CIFAR100/cifar100-novel.txt"

@DATASET_REGISTRY.register()
class cifar100(DatasetBase):

    dataset_dir = "CIFAR100/cifar-100-python"
    ...
    def __init__(self, cfg):
        ...
        self.split_path = os.path.join(self.dataset_dir, "split_ours_cifar100.json")
        ...
        if num_shots >= 1:
            ...
            #preprocessed = os.path.join(self.split_fewshot_dir, f"shot_{num_shots}-seed_23.pkl")             # fixed train feature
